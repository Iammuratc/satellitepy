...
def get_args():
    ...
    parser.add_argument('--skip-possibility', type=int, required=False, default=10,
                        help='Only used by block mode. Possibilty when a block should be skipped to greate "holes" ('
                             'Default: 10)')
...
def run(args):
    ...
    log_path = output_folder / f'mask_image.log' if args.log_path is None else args.log_path
