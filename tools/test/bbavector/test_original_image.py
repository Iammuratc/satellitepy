...
def get_args():
    ...
    parser.add_argument('--patch-size', type=int,
                        help='Patch size. Patches with patch_size will be created from the original image to be '
                             'tested by the model. Be sure patch_size is the same as the input image size of '
                             'your model, if not it will be resized to the input size.')
    parser.add_argument('--patch-overlap', type=int,
