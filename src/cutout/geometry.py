...
class Rectangle:
    ...
    def __init__(self, bbox):
        ...
        self.bbox = bbox
        self.cx, self.cy, self.h, self.w, self.angle = self.get_params(
            self.bbox)
    ...
    def get_params(bbox):
        ...
        def x_dif(i_0, i_1): return bbox[i_0, 0] - bbox[i_1, 0]
        def y_dif(i_0, i_1): return bbox[i_0, 1] - bbox[i_1, 1]
    ...
    def get_atan2(self):  # ,img_shape):
        ...
        if (self.bbox[0, 1] - self.bbox[1, 1] >=
                0) and (self.bbox[0, 0] - self.bbox[1, 0] >= 0):
            # print('q1')
