...
import requests
# NOTES: y axis of matplotlib figures are inverted, so the airplanes will
# be actually facing downwards, pay attention at the new datasets
...
class DataDem:
    ...
    def __init__(self, settings, dataset_part):
        ...
        # EX:
        # /home/murat/Projects/airplane_recognition/data/Gaofen/train/recognition/no_duplicates.json
    ...
    def remove_duplicates(self):
        ...
        sequences = requests.get(
            f"{dqp_url}/image-sequence",
            params=params).json()
